...
* **ADPlus**: A script to automate the capture of dumps on specific events (e.g., unhandled exceptions, high CPU usage, performance issues etc) using WinDbg.

>PS: On GitHub, I have a [collection of scripts](https://github.com/mithunshanbhag/dbg-scripts) to aid debugging on Windows.
...
**[Sysinternals suite](https://docs.microsoft.com/en-us/sysinternals/)**: An awesome, awesome suite of diagnostic & administration tools for Windows. Looks like there is now an [effort underway to port these tools to linux](https://github.com/microsoft/procdump-for-linux).
